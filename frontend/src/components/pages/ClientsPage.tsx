  ...
  return (
    <div ref={ref} className="relative flex-none" style={{ width: "200px" }}>
      <button
        ...
        className={`flex items-center justify-between gap-2 w-full border rounded-full text-sm transition-all shadow-sm cursor-pointer h-[42px] ${
          selected
            ...
            : "border-gray-200 bg-white text-gray-600 hover:border-gray-300 px-5"
        }`}
      >
        ...
        <ChevronDown
          size={16}
          className={`transition-transform duration-200 shrink-0 ${selected ? "text-white" : ""} ${open ? "rotate-180" : ""}`}
        />
      </button>
