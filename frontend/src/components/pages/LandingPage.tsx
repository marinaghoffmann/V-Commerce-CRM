...
export default function LandingPage() {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen w-full font-sans">
      {/* Left Panel */}
      <div 
        className="w-full md:w-1/2 flex flex-col justify-center px-12 lg:px-24 py-16 text-white relative"
      ...
      {/* Right Panel */}
      <div className="w-full md:w-1/2 bg-[#FBFBFB] flex flex-col justify-center items-center px-12 lg:px-24 py-16 relative">
