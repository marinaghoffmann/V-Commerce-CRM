...
class ClienteBase360(Base):
    ...
    telefone_ramal:             Mapped[str]   = mapped_column(String)
    ...
    data_primeira_compra:       Mapped[Date]  = mapped_column(Date)
    data_ultima_compra:         Mapped[Date]  = mapped_column(Date)
    metodo_pagamento_preferido: Mapped[str]   = mapped_column(String)
    categoria_preferida:        Mapped[str]   = mapped_column(String)
    produto_mais_comprado:      Mapped[str]   = mapped_column(String)
